        ...
        <div className={`col-sm-4 ${styles.mealItem}`}>
            <div className={styles.innerItem}>
                <button className={`${styles.fvrt}`} onClick={fvrtHandler}>
                    {fvrt
                        ? <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#FF0000" class="bi bi-heart-fill" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z" />
                        </svg>
                        : <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#000000" class="bi bi-heart" viewBox="0 0 20 20">
