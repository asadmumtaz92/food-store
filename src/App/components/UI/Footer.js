const Footer = () => {
    ...
    return (
        <div className={`row col-sm-12 col-md-12 col-lg-12 col-xl-12 bg-dark text-white pt-3 pb-3`} style={{padding:0, margin:0,width:'100%', right:0,left:0, position:'absolute'}}>
