...
const Cart = (props) => {
    ...
    const CartItem = (item) => {
        ...
        return (
            <div className="row mt-3 justify-content-between" style={{ 'border-bottom': '1px solid lightgray' }}>
                <div className="col-sm-2 col-md-2 col-lg-2 col-xl-1">
                    <img src={itemDetail?.logo} className={`${styles.image}`} alt='food logo...' />
                </div>

                <div className="col-sm-3 col-md-3 col-lg-3 col-xl-3 mt-5 text-left">
                    <h5 className={`pl-1 ${styles.heading}`}>{itemDetail?.name}</h5>
                </div>

                <div className="col-sm-2 col-md-1 col-lg-2 col-xl-2 mt-5">
                    <p className={`${styles.text}`}>{formatter.format(itemDetail?.price)}</p>
                </div>

                <div className="col-sm-2 col-md-3 col-lg-2 col-xl-3 mt-4 pt-4">
                    <div className="row justify-content-center">
                        <div className="col-sm-4 col-md-4 col-lg-4 col-xl-3 text-center">
                            <button className={styles.qtyBtn} onClick={decremetHandler}>
                                <i className="fa fa-minus-square" style={{ fontSize: 25 }}></i>
                            </button>
                        </div>
                        <div className="col-sm-4 col-md-4 col-lg-4 col-xl-2 text-cent">
                            <p className={styles.qty}>{itemDetail?.qty}</p>
                        </div>
                        <div className="col-sm-4 col-md-4 col-lg-4 col-xl-3 text-center">
                            <button className={styles.qtyBtn} onClick={incrementHandler}>
                                <i className="fa fa-plus-square" style={{ fontSize: 25 }}></i>
                            </button>
                        </div>
                    </div>
                </div>

                <div className="col-sm-2 col-md-2 col-lg-2 col-xl-1 mt-5 text-right">
                    <p className={`${styles.text}`}>{formatter.format(itemDetail?.price * itemDetail?.qty)}</p>
                </div>

                <div className="col-sm-1 col-md-1 col-lg-1 col-xl-1 mt-5 text-right">
    ...
    const IpComp = ({label, refName, placeholder, type='text'}) => {
        return (
            <>
                <div className="col-sm-6 col-md-6 col-lg-6 col-xl-6 align-self-end">
                    <h6 className={`${styles.heading}`}>{label}:</h6>
                </div>
                <div className=" col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-2">
                    <input type={type} ref={refName} className="form-control" placeholder={placeholder} required/>
                </div>
            </>
        )
    }
    ...
    return (
        <React.Fragment>
            <div className={`container-fluid mt-5 pt-4`} style={{minHeight:'87vh'}}>
                ...
                <div className="row justify-content-center bg-dark pt-5 pb-5">
                    <div className="col-sm-11 col-md-9 col-lg-9 col-xl-9 bg-white rounded">
                        {/* BODY */}
                        {!isLoading && 
                        ...
                        {(props?.cartItems?.length > 0 && !isLoading)
                            ? <>
                                {/* USER INFO */}
                                <div className="row col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-4">
                                ...
                                <div className="row col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                    <div className="col-sm-6 col-md-6 col-lg-6 col-xl-6 align-self-center">
                                        <h6 className={`${styles.heading}`}>Payment Method:</h6>
                                    </div>
                                    <div className="col-sm-6 col-md-6 col-lg-6 col-xl-4">
                                        <select name="cars" className="custom-select mb-3" ref={paymentRef}>
                                ...
                                {/* BILL DETAIL */}
                                <div className="row col-sm-12 col-md-12 col-lg-12 col-xl-12 bg-drak">
                                ...
                                <div className="col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-4 mb-3 text-center">
                                    <Button
                                ...
                                {/* <div className="col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-4"></div> */}
                            </>
                            : isLoading && <p className={`text-center pt-5 pb-4 font-weight-bold`}><i className="fa fa fa-spinner fa-spin"></i> Processing wait...</p>
                        }
                    </div>
                </div>
            </div>
